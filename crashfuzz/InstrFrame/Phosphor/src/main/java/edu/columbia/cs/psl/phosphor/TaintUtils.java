...
public class TaintUtils {
    ...
    public static final String FAV_BUFFER_MSGID_FIELD = "FAV_MSG_ID";//favtrigger
    public static final String FAV_RECORD_TAG = "FAV_SHOULD_RECORD";//favtrigger
    public static final String FAV_HDFSSTREAM_PATH = "FAV_HDFSSTREAM_PATH";//favtrigger
    public static final String FAV_FILEDESCRIPTOR_MT = "favGetParentPath";//favtrigger
    public static final String FAV_GETFILESTREAMPATH_MT = "favGetFileStreamPath";//favtrigger
    public static final String FAV_GETBUFFERTAINTS_MT = "favGetHBTaints";//favtrigger
    public static final String FAV_GETBUFFERSHADOW_MT = "favGetHBShadow";//favtrigger
    public static final String FAV_FILEOUT_NOTRECORD = "favNotRecordToFile";//favtrigger
    public static final String FAV_RPC_SOCKET = "FAV_DEST_IP";
    public static final String FAV_PATH = "FAV_FILE_PATH";//favtrigger
    public static final String FAV_TAINT_PATH = "FAV_TAINT_PATH";//favtrigger
    public static final String FAV_INST_MARK = "FAV_INSTUMENTED";//favtrigger
