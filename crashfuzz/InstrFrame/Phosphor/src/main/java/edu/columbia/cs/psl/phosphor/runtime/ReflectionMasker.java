...
public class ReflectionMasker {
     ...
     */
    //private static int fillInParams(LazyReferenceArrayObjTags targetArgs, LazyReferenceArrayObjTags providedArgs, Class<?>[] paramTypes) {//favtrigger: commented out
        ...
        if(providedArgs != null) {
            ...
            for(Object providedArg : providedArgs.val) {
                ...
                if(providedArgs.taints == null) {
                    targetArgs.val[targetParamIndex++] = Taint.emptyTaint(); //favtrigger commented out
                    //favtrigger: start
            ...
            if(chars.length == SET_TAG_METHOD_LEN) {
                ...
                for(int i = 3; i < SET_TAG_METHOD_LEN; i++) {
                    if(chars[i] != SET_TAG_METHOD_CHARS[i]) {
                        match = false;
                        break;
                        //favtrigger: here mask getPHOSPHOR_TAG and setPHOSPHOR_TAG
                    }
                }
            }
