...
public final class LazyByteArrayObjTags extends LazyArrayObjTags {
    ...
    public void set(int idx, byte val, Taint tag) {
        this.val[idx] = val;
        if(taints == null && tag != null && !tag.isEmpty()) {//favtrigger
        //commented out
        //this aims to save memory space
        //if(taints == null && tag != null) {//favtrigger add
            //favtrigger: original phosphor code would not keep the empty taint value
