...
. /home/gaoyu/evaluation/hbase-2.4.8/fav-env.sh
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS $HBASE_JMX_BASE $PHOS_OPTS $TIME_OPTS"
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS $HBASE_JMX_BASE $PHOS_OPTS $TIME_OPTS"
export HBASE_THRIFT_OPTS="$HBASE_THRIFT_OPTS $HBASE_JMX_BASE $PHOS_OPTS $TIME_OPTS"
export HBASE_ZOOKEEPER_OPTS="$HBASE_ZOOKEEPER_OPTS $HBASE_JMX_BASE $PHOS_OPTS $TIME_OPTS"
export HBASE_REST_OPTS="$HBASE_REST_OPTS $HBASE_JMX_BASE  $PHOS_OPTS $TIME_OPTS"
#export HBASE_SSH_OPTS="$PHOS_OPTS $TIME_OPTS"
export HBASE_SHELL_OPTS="$HBASE_SHELL_OPTS $PHOS_OPTS $TIME_OPTS"
