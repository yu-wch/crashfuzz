...
cp -r bin-rec bin
rm fav-env.sh
cp fav-env-random.sh fav-env.sh
...
docker cp allowlist C1ZK1:/home/gaoyu/evaluation/zk-3.6.3
docker cp allowlist C1ZK2:/home/gaoyu/evaluation/zk-3.6.3
docker cp allowlist C1ZK3:/home/gaoyu/evaluation/zk-3.6.3
docker cp allowlist C1ZK4:/home/gaoyu/evaluation/zk-3.6.3
docker cp allowlist C1ZK5:/home/gaoyu/evaluation/zk-3.6.3

docker cp denylist C1ZK1:/home/gaoyu/evaluation/zk-3.6.3
docker cp denylist C1ZK2:/home/gaoyu/evaluation/zk-3.6.3
docker cp denylist C1ZK3:/home/gaoyu/evaluation/zk-3.6.3
docker cp denylist C1ZK4:/home/gaoyu/evaluation/zk-3.6.3
docker cp denylist C1ZK5:/home/gaoyu/evaluation/zk-3.6.3
